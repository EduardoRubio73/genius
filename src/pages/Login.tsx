        ...
        {!isSignUp && (
          <>
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-white px-4 py-3 font-semibold text-gray-700 shadow-sm transition-all hover:shadow-md hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
            >
